...
Identity: same pet in every frame: A compact mint-green plush helper with a rounded body, tiny cream belly patch, expressive dark eyes, short teal ear tufts, and a small yellow satchel; soft felt texture, friendly and readable at pet size.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `plush`: Soft plush toy mascot with rounded stitched forms, fuzzy fabric feel, simple sewn details, and readable toy-like proportions. User style notes: soft felt plush mascot, clean rounded silhouette, gentle studio illustration.
